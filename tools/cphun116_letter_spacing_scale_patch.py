...
# CPHUN-116 is intentionally based on the known-good CPHUN-114 state.
# It only retunes the letter-spacing threshold scale; no input/button code is touched.
...
print("CPHUN-116 applied from CPHUN-114 baseline: 10..70% -> 550..400% thresholds")
