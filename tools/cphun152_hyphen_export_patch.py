...
# Adapt every remaining call site to the new glyph-accepting function signature.
s = s.replace("trailingShortHyphenInkShift(renderer, fontId, style)",
              "trailingShortHyphenInkShift(renderer, fontId, style, shortGlyph)")
